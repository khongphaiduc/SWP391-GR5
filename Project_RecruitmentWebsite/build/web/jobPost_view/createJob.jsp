            ...
            <form action="createJob" method="post">
                <div class="form-grid">
                    ...
                    <div class="form-column">
                        ...
                        <input type="text" name="offerMin" step="1000" placeholder="Nhập lương tối thiểu" required oninput="formatCurrencyInput(this)">

                        <label>Lương tối đa (VNĐ)</label>
                        <input type="text" name="offerMax" step="1000" placeholder="Nhập lương tối đa" required oninput="formatCurrencyInput(this)">
