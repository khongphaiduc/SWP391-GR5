                    ...
                    <div class="row gy-5 gx-4">
                        <div class="col-lg-8">
                            <div class="d-flex align-items-center mb-5">
                                ...
                                <div class="text-start ps-4">
                                    ...
                                    <span class="text-truncate me-3"><i class="far fa-clock text-primary me-2"></i><%=job.getTypeJob()%></span>
                                    <span class="text-truncate me-0"><i class="far fa-money-bill-alt text-primary me-2"></i>$<%=job.getOffer_Min()%>-$<%=job.getOffer_Max()%></span>
                                </div>
                            </div>
                            ...
                            <div class="">
                                <h4 class="mb-4">Ứng tuyển cho công việc này (yêu cầu ứng viên đăng nhập)</h4>
                        ...
                        <div class="col-lg-4">
                            <div class="bg-light rounded p-5 mb-4 wow slideInUp" data-wow-delay="0.1s">
                                ...
                                <p><i class="fa fa-angle-right text-primary me-2"></i>Published On: <%=job.getDayCre()%></p>
                                <p><i class="fa fa-angle-right text-primary me-2"></i>Địa điểm:<%=job.getLocation()%></p>
                                <p><i class="fa fa-angle-right text-primary me-2"></i>Loại công việc: <%=job.getTypeJob()%></p>
