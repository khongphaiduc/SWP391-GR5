    ...
    <head>
        ...
        <style>
            * {
            ...
            .btn-view:hover {
                background: linear-gradient(135deg, #00b386, #009e75);
                ...
                <div class="cv-card">
                    ...
                    <div class="cv-body">
                        ...
                        <div class="cv-actions">
                            <a href="viewCV?cvId=<%= cv.getCvId() %>" class="btn btn-view" target="_blank">
                                <i class="fas fa-eye"></i> Xem CV
                            </a>
                            <form method="post" action="manageCreatedCV" style="flex: 1;">
                            ...
                            <form method="post" action="manageCreatedCV" style="flex: 1;" onsubmit="return confirm('Bạn có chắc chắn muốn xóa CV này không?');">
                ...
                <div class="pagination">
                    ...
                    <div class="page-size-control">
                        ...
                        <form action="manageCreatedCV" style="display: flex; align-items: center; gap: 8px;">
                            <input type="number" name="pageSize"  min="1" max="20">
