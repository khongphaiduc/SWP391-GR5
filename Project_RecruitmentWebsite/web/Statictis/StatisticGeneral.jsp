    ...
    <head>
        ...
        <style>
            ...
            .kpi-card {
                background: #fff;
                border-radius: 14px;
                box-shadow: 0 3px 16px rgba(67, 160, 71, 0.10);
            ...
            .kpi-card:nth-child(2) .kpi-icon, .kpi-card:nth-child(2) .kpi-value {
                color: #388e3c;
            }
            .kpi-card:nth-child(3) {
                border-left-color: #fd7e14;
            }
            .kpi-card:nth-child(3) .kpi-icon, .kpi-card:nth-child(3) .kpi-value {
                color: #fd7e14;
            }
            .kpi-card:nth-child(4) {
                border-left-color: #5116ac;
            }
            .kpi-card:nth-child(4) .kpi-icon, .kpi-card:nth-child(4) .kpi-value {
                color: #5116ac;
            }
            .chart-title {
                text-align: left;
            ...
            .chart-box {
                ...
                padding: 0.9rem 0.6rem 1rem 1rem;
